...
2.  Select the driver DC. Results from subsequent phases need to be collected
...
3.  Discover every snaplink. This involves working through each Manta index
...
4.  Run delinking scripts.
    ...
    `SNAPLINK_CLEANUP_REQUIRED` metadatum to indicate that snaplink clean
    is complete!
...
5.  Update webapi configs and restart.
...
6.  Tidy up "sherlock" leftovers from stage 3.
